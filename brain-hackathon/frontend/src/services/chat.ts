...
// --------------- Mock fallback (used when backend is down) ---------------
...
async function sendMockMessage(req: ChatRequest): Promise<ChatResponse> {
